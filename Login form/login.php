    ...
    <div class="bg">
        <div class="login">
            <form class="logo" id="form" action="" method="POST">
                ...
                <h1>Log in to your CNN account</h1>
                <p>Don't have an account? <a href="singup.php"><span id="span">Sign up</span></a></p>
                <p>Login as Admin? <a href="loginAdmin.php"><span id="span">Login</span></a></p>
                <br><br>
                <?php
                    include '../modeli.php';
                    $model = new Model();
                    $insert = $model->loginUser();  
                ?>
