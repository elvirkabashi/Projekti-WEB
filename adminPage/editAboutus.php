...
<?php   
              ...
              if (isset($_POST['update'])) {
                if (isset($_POST['about'])) {
                    ...
                    $update = $model->updateAboutus($data);
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <label>Photo:</label>
        <input type="file" name="photo" ><img src="../img/<?php echo $row['photo']; ?>" style="width: auto; height:170px;"><br><br>
        <textarea cols="30" rows="10" placeholder="more about the news.." name="about" maxlength="1500"><?php echo $row['info']; ?></textarea><br><br>
