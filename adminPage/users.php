...
<table id="table">
  <thead>
    ...
    <tr>
      ...
      <th>Email</th>
      <th>Delete</th>
      <th><a href="user.php"><button style="margin-left:5px" id="usr-btn">Admins</button></a></th>
    </tr>
  </thead>
  <tbody>
...
<script>
  function checkDelete(delId){
      if(confirm('Deshironi te fshini Userin?')){
          document.location.href = 'deleteUser.php?id='+delId;
          return true;
      }
  }
</script>
